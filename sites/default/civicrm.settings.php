...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://lfconf_drup:Ew7P9fd6@localhost/lfconf_drup?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define( 'CIVICRM_DSN'          , 'mysql://lfconf_civi:3785u6@localhost/lfconf_civi?new_link=true' );
  }
}
...
$civicrm_root = '/home/members/leftforum/sites/conference.leftforum.org/web/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/members/leftforum/sites/conference.leftforum.org/web/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://www.leftforum.org/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'db275c226c9fb9a1325fb2b38da32759');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/members/leftforum/sites/conference.leftforum.org/web/sites/default/files/civicrm/templates_c//mail.log');
// }
